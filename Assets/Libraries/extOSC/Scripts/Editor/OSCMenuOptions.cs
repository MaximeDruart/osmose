...
namespace extOSC.Editor
{
    public static class OSCMenuOptions
    {
        ...
        [MenuItem(_objectRoot + "RotaryEdited", false, _objectIndex + 13)]
        public static void AddRotaryEdited(MenuCommand menuCommand)
        {
            OSCWindowControlCreator.Open(menuCommand, (data, command) => { InitUIElement<OSCRotaryEdited, OSCTransmitterInformerFloat>(OSCControls.CreateRotaryEdited, data, command); });
        }
